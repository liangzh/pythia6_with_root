...
//	h_Q2VsxBj_Pair = new TH2D("h_Q2VsxBj_Pair", "log_{10}(Q^{2}) vs log_{10}(x_{Bj});log_{10}(x_{Bj});log_{10}(Q^{2})", 50, -5, 0, 50, 0, 4);
	...
	h_Q2VsxBj_D0 = getLogXYBin("h_Q2VsxBj_D0", "Q^{2} vs x_{Bj};x_{Bj};Q^{2}", 50, 1E-5, 1, 50, 1, 1E3);
	h_Q2VsxBj_Pair = getLogXYBin("h_Q2VsxBj_Pair", "Q^{2} vs x_{Bj};x_{Bj};Q^{2}", 40, 1E-5, 1, 40, 1, 1E3);
	h_Q2VsxBj_Pair_PGF = getLogXYBin("h_Q2VsxBj_Pair_PGF", "Q^{2} vs x_{Bj};x_{Bj};Q^{2}", 40, 1E-5, 1, 40, 1, 1E3);
	h_Q2VsxBj_Pair_1 = getLogXYBin("h_Q2VsxBj_Pair_1", "Q^{2} vs x_{Bj};x_{Bj};Q^{2}", 40, 1E-5, 1, 40, 1, 1E3);
	h_Q2VsxBj_Pair_2 = getLogXYBin("h_Q2VsxBj_Pair_2", "Q^{2} vs x_{Bj};x_{Bj};Q^{2}", 40, 1E-5, 1, 40, 1, 1E3);
	h_Q2VsxBj_Pair_xg = getLogXYBin("h_Q2VsxBj_Pair_xg", "Q^{2} vs x_{Bj};x_{Bj};Q^{2}", 40, 1E-5, 1, 40, 1, 1E3);
	h_Q2VsxBj_qqbar = getLogXYBin("h_Q2VsxBj_qqbar", "Q^{2} vs x_{Bj};x_{Bj};Q^{2}", 50, 1E-5, 1, 50, 1, 1E3);
